<?php
namespace content_protection\occasion\detail;
...
class view
{
	public static function config()
	{
		...
		\dash\data::page_title(T_("Details of register agent in this occasion"));

		\dash\data::page_pictogram('list');

		\dash\data::badge_link(\dash\url::this(). '/agent?id='. \dash\request::get('id'));
