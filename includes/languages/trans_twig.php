...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Shahid Mahdi Imani");                                                    // Line 98
	...
	echo T_("Do you know?");                                                          // Line 162
	echo T_("Family trip signup");                                                    // Line 65
	echo T_("Group trip signup");                                                     // Line 68
	echo T_("Mashhad");                                                               // Line 21
	echo T_("Karbala");                                                               // Line 30
	echo T_("license and supporters");                                                // Line 214
	echo T_("Certificate");                                                           // Line 219
	echo T_("Secured by Arvancloud");                                                 // Line 220
	echo T_("Arvancloud");                                                            // Line 220
	echo T_("Last news");                                                             // Line 263
	...
	echo T_("Donate list");                                                           // Line 70
	echo T_("Request service list");                                                  // Line 71
	echo T_("Request trip list");                                                     // Line 73
	echo T_("Homepage settings");                                                     // Line 74

	//----------------------------------------------------content_cp/home/display.html
	echo T_("Donate product list");                                                   // Line 22
	...
	echo T_("Donate product");                                                        // Line 75
