...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Be good too");                                                           // Line 43
	echo T_("Untitled");                                                              // Line 27
	echo T_("Anonymous");                                                             // Line 30
	echo T_("Toman");                                                                 // Line 181
	...
	echo T_("Requested");                                                             // Line 99
	echo T_("Your help");                                                             // Line 105
	echo T_("Enter a valid number");                                                  // Line 105
	echo T_("Pay");                                                                   // Line 124
	echo T_("First name");                                                            // Line 48
	echo T_("Your name");                                                             // Line 132
	echo T_("Enter a valid name");                                                    // Line 132
	echo T_("Full name");                                                             // Line 140
	echo T_("Enter a valid last name");                                               // Line 140
	echo T_("Enter a valid mobile");                                                  // Line 151
	echo T_("Enter a valid email");                                                   // Line 160
	echo T_("Intent");                                                                // Line 169
	echo T_("Intention to donate this fee");                                          // Line 171
	echo T_("Enter a valid niyat");                                                   // Line 171
	...
	echo T_("Manual");                                                                // Line 212
	echo T_("Normal");                                                                // Line 212
	echo T_("Admin direct pay");                                                      // Line 213
	echo T_("Spending method");                                                       // Line 53
	echo T_("Please select one item");                                                // Line 179

	//-------------------------------------content/template/static/mahdi-imani-fa.html
	echo T_("Shahid Mahdi Imani");                                                    // Line 77

	//--------------------------------------------content/template/static/mission.html
	echo T_("Soon");                                                                  // Line 6

	//------------------------------------------------content/template/static/faq.html

	//-------------------------------------------content/template/static/masoumeh.html

	//---------------------------------------------content/template/static/honors.html

	//----------------------------------------content/template/static/certificate.html

	//---------------------------------------------content/template/static/vision.html

	//----------------------------------------------content/template/static/intro.html
	echo T_("About");                                                                 // Line 42
	echo T_("Do you know?");                                                          // Line 88
	echo T_("Family trip signup");                                                    // Line 92
	echo T_("Group trip signup");                                                     // Line 93
	echo T_("Mashhad");                                                               // Line 21
	echo T_("Karbala");                                                               // Line 30
	echo T_("license and supporters");                                                // Line 141
	echo T_("Certificate");                                                           // Line 146
	echo T_("Secured by Arvancloud");                                                 // Line 147
	echo T_("Arvancloud");                                                            // Line 147
	echo T_("Last news");                                                             // Line 185

	//----------------------------------------------content/template/static/about.html

	//----------------------------------------content/template/static/mahdi-imani.html
	...
	echo T_("Donate list");                                                           // Line 71
	echo T_("Donate product list");                                                   // Line 72
	echo T_("Request service list");                                                  // Line 73
	echo T_("Request trip list");                                                     // Line 75
