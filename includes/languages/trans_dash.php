...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Help tags");                                                             // Line 34
	echo T_("Support tags");                                                          // Line 38
