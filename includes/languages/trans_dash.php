...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Require");                                                               // Line 178
	echo T_("Description");                                                           // Line 248
	...
	echo T_("Title");                                                                 // Line 59
	echo T_("Price");                                                                 // Line 20
	echo T_("Count");                                                                 // Line 44
	...
	echo T_("Active");                                                                // Line 172
	echo T_("Awaiting");                                                              // Line 225
	echo T_("Deactive");                                                              // Line 192
	echo T_("Filter");                                                                // Line 211
	echo T_("Unreachable");                                                           // Line 221
	echo T_("Permission");                                                            // Line 98
	echo T_("No permission");                                                         // Line 116
	echo T_("Email");                                                                 // Line 20
	...
	echo T_("API");                                                                   // Line 30
	echo T_("Introduction");                                                          // Line 32
	echo T_("Endpoints");                                                             // Line 3
	echo T_("Responses");                                                             // Line 3
	echo T_("Token");                                                                 // Line 8
	echo T_("Verify user");                                                           // Line 5
	echo T_("Get about");                                                             // Line 48
	echo T_("Get mission");                                                           // Line 50
	echo T_("Get vision");                                                            // Line 52
	echo T_("Get contact");                                                           // Line 54
	echo T_("Check new notification");                                                // Line 56
	...
	echo T_("You can create backup now");                                             // Line 12
	echo T_("Backup now");                                                            // Line 13
	...
	echo T_("No backup was found");                                                   // Line 42
	...
	echo T_("Message");                                                               // Line 43

	//------------------------------------------addons/content_su/tg/home/display.html
	echo T_("Logs");                                                                  // Line 83
	echo T_("Users");                                                                 // Line 12
	...
	echo T_("What do you want to send to this user?");                                // Line 14
	...
	echo T_("Log");                                                                   // Line 16
	echo T_("Translation tools");                                                     // Line 41
	...
	echo T_("Please select one item");                                                // Line 120
	...
	echo T_("The permission name should be unique and contain only alphanameric characters and underscores");// Line 9
	echo T_("Name of your permission");                                               // Line 9
	echo T_("Label");                                                                 // Line 17
	echo T_("The permission label is used to represent your permission in user management");// Line 13
	echo T_("Label of your permission");                                              // Line 13
	...
	echo T_("Try to start with add new record!");                                     // Line 115

	//----------------------------------------addons/content_crm/log/home/display.html
	echo T_("All publish log");                                                       // Line 62
	echo T_("Published");                                                             // Line 129
	...
	echo T_("Please select one itme");                                                // Line 237
