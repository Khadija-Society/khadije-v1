...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Edit");                                                                  // Line 316
	echo T_("Firstname");                                                             // Line 127
	echo T_("Lastname");                                                              // Line 136
	...
	echo T_("Status");                                                                // Line 152
	echo T_("Select one item");                                                       // Line 153
	echo T_("Enable");                                                                // Line 238
	echo T_("Disable");                                                               // Line 239
	echo T_("Removed");                                                               // Line 157
	echo T_("Add");                                                                   // Line 53
	...
	echo T_("Security and Enter");                                                    // Line 12
	echo T_("Improve User Experience");                                               // Line 42
	echo T_("Two step verification");                                                 // Line 178
	echo T_("Show sidebar");                                                          // Line 145
	echo T_("Default language");                                                      // Line 80
	...
	echo T_("Gmail");                                                                 // Line 115
	echo T_("Like");                                                                  // Line 90
	echo T_("Enter a valid firstname from 3 to 40 character");                        // Line 127
	echo T_("Enter a valid lastname from 3 to 40 character");                         // Line 136
	echo T_("Username");                                                              // Line 156
	echo T_("Enter a valid username from 3 to 40 character");                         // Line 118
	echo T_("Nick name");                                                             // Line 78
	echo T_("Enter a valid title from 3 to 40 character");                            // Line 154
	echo T_("Type");                                                                  // Line 164
	echo T_("Enter a valid type from 3 to 40 character");                             // Line 164
	echo T_("Birthday");                                                              // Line 134
	echo T_("Bio");                                                                   // Line 82
	echo T_("Display name");                                                          // Line 96
	echo T_("Enter a valid displayname from 3 to 40 character");                      // Line 187
	echo T_("Like 09120123456");                                                      // Line 53
	echo T_("Gender");                                                                // Line 144
	echo T_("Male");                                                                  // Line 147
	echo T_("Female");                                                                // Line 148
	echo T_("Active");                                                                // Line 154
	echo T_("Awaiting");                                                              // Line 155
	echo T_("Deactive");                                                              // Line 156
	echo T_("Filter");                                                                // Line 158
	echo T_("Unreachable");                                                           // Line 159
	echo T_("Permission");                                                            // Line 96
	echo T_("No permission");                                                         // Line 101
	...
	echo T_("Confirm password");                                                      // Line 133
	echo T_("Require to change current password");                                    // Line 133
	echo T_("Password was set, enter to change it!");                                 // Line 135
	echo T_("Password not set, enter to set it!");                                    // Line 272
	echo T_("Save all");                                                              // Line 298

	//-------------------------------addons\content_account\profile\other\display.html
	echo T_("Remove");                                                                // Line 18
	...
	echo T_("Save remember session");                                                 // Line 169
	echo T_("Active sessions");                                                       // Line 196
	echo T_("Terminate all other sessions");                                          // Line 113
	echo T_("Browser");                                                               // Line 199
	echo T_("Operation System");                                                      // Line 200
	echo T_("IP");                                                                    // Line 22
	echo T_("Date login");                                                            // Line 202
	echo T_("Current session");                                                       // Line 204
	echo T_("Terminate");                                                             // Line 206
	...
	echo T_("News");                                                                  // Line 14
	echo T_("Pages");                                                                 // Line 26
	...
	echo T_("Notification");                                                          // Line 263
	echo T_("Telegram");                                                              // Line 417
	...
	echo T_("Have chatid");                                                           // Line 389
	echo T_("Have not chatid");                                                       // Line 396
	echo T_("Have email");                                                            // Line 495
	echo T_("Have not email");                                                        // Line 502
	echo T_("Try to start with add new user!");                                       // Line 187
	echo T_("Filter by username");                                                    // Line 216
	echo T_("Filter by avatar");                                                      // Line 221
	echo T_("Filter by displayname");                                                 // Line 226
	echo T_("Filter by mobile");                                                      // Line 231
	echo T_("Filter by email");                                                       // Line 236
	echo T_("Filter by password");                                                    // Line 241
	echo T_("Filter by twostep");                                                     // Line 246
	echo T_("Filter by permission");                                                  // Line 251
	echo T_("Filter by chatid");                                                      // Line 256
	echo T_("Filter by language");                                                    // Line 261
	echo T_("Filter by android_uniquecode");                                          // Line 266
	echo T_("Filter by duplicate");                                                   // Line 272
	echo T_("Clear filter");                                                          // Line 281
	echo T_("Apply");                                                                 // Line 282
	echo T_("Have duplicate mobile");                                                 // Line 295
	echo T_("Have duplicate email");                                                  // Line 302
	echo T_("Have duplicate username");                                               // Line 309
	echo T_("Have duplicate chatid");                                                 // Line 316
	echo T_("Have duplicate android_uniquecode");                                     // Line 323
	echo T_("Have android_uniquecode");                                               // Line 337
	echo T_("Have not android_uniquecode");                                           // Line 344
	echo T_("Non");                                                                   // Line 616
	echo T_("Have language");                                                         // Line 363
	echo T_("Have not language");                                                     // Line 370
	echo T_("Have permission");                                                       // Line 415
	echo T_("Have not permission");                                                   // Line 422
	echo T_("Have twostep");                                                          // Line 441
	echo T_("Have not twostep");                                                      // Line 448
	echo T_("Have password");                                                         // Line 468
	echo T_("Have not password");                                                     // Line 475
	echo T_("Have mobile");                                                           // Line 522
	echo T_("Have not mobile");                                                       // Line 529
	echo T_("Have displayname");                                                      // Line 548
	echo T_("Have not displayname");                                                  // Line 555
	echo T_("Have avatar");                                                           // Line 574
	echo T_("Have not avatar");                                                       // Line 581
	echo T_("Have username");                                                         // Line 602
	echo T_("Have not username");                                                     // Line 609
	...
	echo T_("Enter to change pass");                                                  // Line 124
	echo T_("Password not set, enter  to set it!");                                   // Line 135
	...
	echo T_("Panel");                                                                 // Line 94
	echo T_("CRM Panel");                                                             // Line 102
	echo T_("Supervisor Panel");                                                      // Line 106
	echo T_("Your Account");                                                          // Line 110
	echo T_("Help Center");                                                           // Line 113
