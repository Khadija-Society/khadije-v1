...
class twigTransTerms
{
 private function transtext()
 {
	...
	//-------------------------------------addons\content_account\address\display.html
	echo T_("Edit address");                                                          // Line 28
	echo T_("Cancel");                                                                // Line 14
	echo T_("Add new address");                                                       // Line 31
	echo T_("Saved address");                                                         // Line 68
	echo T_("Postal code");                                                           // Line 91
	echo T_("Phone");                                                                 // Line 198
	echo T_("Mobile");                                                                // Line 24
	echo T_("Edit");                                                                  // Line 330
	echo T_("Firstname");                                                             // Line 152
	echo T_("Lastname");                                                              // Line 161
	echo T_("Name");                                                                  // Line 95
	echo T_("Name of person in this address");                                        // Line 137
	echo T_("Country");                                                               // Line 119
	echo T_("Choose your country");                                                   // Line 149
	echo T_("City");                                                                  // Line 166
	echo T_("Select city");                                                           // Line 168
	echo T_("Post code");                                                             // Line 180
	echo T_("Title of address");                                                      // Line 189
	echo T_("Fax");                                                                   // Line 206
	echo T_("Address");                                                               // Line 51
	echo T_("Require");                                                               // Line 19
	echo T_("Yes");                                                                   // Line 232
	echo T_("No");                                                                    // Line 232
	echo T_("Is this a company's address?");                                          // Line 233
	echo T_("Company name");                                                          // Line 240
	echo T_("Status");                                                                // Line 143
	echo T_("Select one item");                                                       // Line 250
	echo T_("Enable");                                                                // Line 222
	echo T_("Disable");                                                               // Line 223
	echo T_("Removed");                                                               // Line 254
	echo T_("Add");                                                                   // Line 53
	echo T_("Save");                                                                  // Line 170
	...
	echo T_("Count");                                                                 // Line 55

	//----------------------------------------addons\content_account\home\display.html
	echo T_("Profile");                                                               // Line 8
	...
	echo T_("Birthday");                                                              // Line 194
	echo T_("Bio");                                                                   // Line 204
	echo T_("Display name");                                                          // Line 212
	echo T_("Enter a valid displayname from 3 to 40 character");                      // Line 212
	echo T_("Like 09120123456");                                                      // Line 222
	echo T_("Gender");                                                                // Line 230
	echo T_("Male");                                                                  // Line 234
	echo T_("Female");                                                                // Line 239
	...
	echo T_("No permission");                                                         // Line 270
	...
	echo T_("Confirm password");                                                      // Line 297
	echo T_("Require to change current password");                                    // Line 297
	echo T_("Password was set, enter to change it!");                                 // Line 299
	echo T_("Password not set, enter to set it!");                                    // Line 272
	echo T_("Save all");                                                              // Line 325
	...
	echo T_("Help Center Article");                                                   // Line 88
	echo T_("Help tags");                                                             // Line 35
	echo T_("Support tags");                                                          // Line 39
	echo T_("Tickets");                                                               // Line 100
	echo T_("Users");                                                                 // Line 62
	echo T_("Permissions");                                                           // Line 69
	...
	echo T_("Published");                                                             // Line 179
	echo T_("All draft log");                                                         // Line 199
	echo T_("Draft");                                                                 // Line 188
	echo T_("All trash log");                                                         // Line 208
	echo T_("Deleted");                                                               // Line 197
	...
	echo T_("Excerpt");                                                               // Line 246
	echo T_("Try to start with add new records!");                                    // Line 270
	echo T_("Category icon");                                                         // Line 293
	echo T_("Select category icon");                                                  // Line 297
	...
	echo T_("Enter to change pass");                                                  // Line 288
	echo T_("Password not set, enter  to set it!");                                   // Line 299
	...
	echo T_("User last visits");                                                      // Line 309
	...
	echo T_("Support Dashboard");                                                     // Line 11
	echo T_("New Ticket");                                                            // Line 17
	echo T_("All");                                                                   // Line 19
	echo T_("Awaiting answer");                                                       // Line 23
	echo T_("Answered");                                                              // Line 27
	echo T_("Unsolved");                                                              // Line 36
	echo T_("Solved");                                                                // Line 37
	echo T_("Open tickets");                                                          // Line 50
	...
	echo T_("Ticket Subject");                                                        // Line 167
	...
	echo T_("Save tag");                                                              // Line 98
	echo T_("Show log");                                                              // Line 109
	echo T_("Last seen");                                                             // Line 118
	echo T_("Ticket No");                                                             // Line 144
	echo T_("Last activity");                                                         // Line 149
	echo T_("Subject of ticket");                                                     // Line 169
	echo T_("Set the title to get faster");                                           // Line 169
	echo T_("User tickets");                                                          // Line 306
	echo T_("This visit detail");                                                     // Line 205
	echo T_("Before create ticket");                                                  // Line 312
	echo T_("View attachment");                                                       // Line 324
	echo T_("Add tag manually to link tickets togethers");                            // Line 388
	echo T_("Current Time");                                                          // Line 403
	echo T_("Notification procedures");                                               // Line 411
