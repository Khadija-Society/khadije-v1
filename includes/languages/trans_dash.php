...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Master");                                                                // Line 130
	echo T_("Choose category of post");                                               // Line 141
	echo T_("Click on special tags to use this depending on your website design");    // Line 158
	echo T_("Tag");                                                                   // Line 167
	echo T_("Add tag manually to link articles togethers");                           // Line 170
	echo T_("Tag keywords...");                                                       // Line 171
	echo T_("Add tag");                                                               // Line 172
	echo T_("Featured Image");                                                        // Line 180
	echo T_("allowed extentions jpg, png. Max 1000Kb");                               // Line 183
	echo T_("Gallery");                                                               // Line 198
	echo T_("Click to download");                                                     // Line 221
	echo T_("Video");                                                                 // Line 211
	echo T_("MP3");                                                                   // Line 217
	echo T_("PDF");                                                                   // Line 219
	echo T_("Without preview");                                                       // Line 221

	//---------------------------------------------------addons/content_cp/layout.html
	echo T_("Dashboard");                                                             // Line 70
	echo T_("News");                                                                  // Line 11
	echo T_("Categries");                                                             // Line 12
	echo T_("Pages");                                                                 // Line 14
	echo T_("Files");                                                                 // Line 15
	echo T_("Users");                                                                 // Line 116
	echo T_("Add new user");                                                          // Line 6
	echo T_("Permissions");                                                           // Line 26
	echo T_("SMS");                                                                   // Line 33
	echo T_("Quick send");                                                            // Line 35
	echo T_("Templates");                                                             // Line 37
