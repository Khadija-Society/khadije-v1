...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Donate");                                                                // Line 17
	echo T_("Deputy pilgrimage");                                                     // Line 184
	echo T_("Consulting");                                                            // Line 107
	...
	echo T_("Full Name");                                                             // Line 136
	echo T_("Mobile");                                                                // Line 63
	echo T_("Please enter valid mobile number. `:val` is incorrect");                 // Line 143
	echo T_("Email");                                                                 // Line 66
	echo T_("Your Message");                                                          // Line 152
	echo T_("Send");                                                                  // Line 151

	//--------------------------------------------------content\donate\donateForm.html
	echo T_("List of last success donations of yours");                               // Line 83
	echo T_("Your niyat is");                                                         // Line 85
	echo T_("Toman");                                                                 // Line 21
	echo T_("Untitled");                                                              // Line 33
	echo T_("Anonymous");                                                             // Line 162
	echo T_("Thanks");                                                                // Line 108
	...
	echo T_("Your Name");                                                             // Line 13
	echo T_("Enter first name and last name to show in doners list or leave it blank");// Line 173
	echo T_("Your mobile number");                                                    // Line 24
	echo T_("If you enter your mobile, we send verify of payment via SMS to this number");// Line 184
	echo T_("Enter a valid email");                                                   // Line 118
	echo T_("Intent");                                                                // Line 188
	echo T_("Intention to donate this fee");                                          // Line 190
	echo T_("It is optional and depending on your intention can enter it");           // Line 204
	echo T_("Pay Amount");                                                            // Line 208
	echo T_("Require");                                                               // Line 54
	echo T_("Rial");                                                                  // Line 336
	echo T_("Amount of your donation");                                               // Line 213
	echo T_("Total Pay Amount");                                                      // Line 206
	echo T_("Count");                                                                 // Line 296
	...
	echo T_("Custom Amount");                                                         // Line 317
	...
	echo T_("Male");                                                                  // Line 128
	echo T_("Female");                                                                // Line 133
	...
	echo T_("Servants registration");                                                 // Line 169
	echo T_("Virtual pilgrimage");                                                    // Line 188
	echo T_("Travel request");                                                        // Line 123
	echo T_("Balloting names");                                                       // Line 186
	echo T_("My love story book");                                                    // Line 158
	...
	echo T_("Mashhad");                                                               // Line 48
	echo T_("Karbala");                                                               // Line 57
	...
	echo T_("Enter a valid amount");                                                  // Line 236
	echo T_("Please select one item");                                                // Line 183
	...
	echo T_("Website");                                                               // Line 206
	echo T_("Submitted on");                                                          // Line 33
	echo T_("Updated on");                                                            // Line 34
	echo T_("Current status");                                                        // Line 36
	echo T_("Status");                                                                // Line 57
	echo T_("Approve");                                                               // Line 104
	echo T_("Awaiting");                                                              // Line 135
	echo T_("Unapprove");                                                             // Line 106
	echo T_("Trash");                                                                 // Line 107
	echo T_("Spam");                                                                  // Line 302
	echo T_("Update");                                                                // Line 63

	//----------------------------------------content_m\admincontact\home\display.html
	echo T_("Search");                                                                // Line 43
	echo T_("Detail");                                                                // Line 303
	echo T_("Date");                                                                  // Line 27
	echo T_("Without name");                                                          // Line 182
	...
	echo T_("No record exist!");                                                      // Line 123
	...
	echo T_("Action");                                                                // Line 83
	echo T_("View");                                                                  // Line 73
	...
	echo T_("Clear filter");                                                          // Line 258
	echo T_("Niyat");                                                                 // Line 152
	echo T_("Hazinekard");                                                            // Line 153
	echo T_("Product donate");                                                        // Line 64
	echo T_("Without mobile");                                                        // Line 191
	echo T_("Item");                                                                  // Line 203
	...
	echo T_("Title");                                                                 // Line 55
	echo T_("Type");                                                                  // Line 56
	echo T_("Sum");                                                                   // Line 14
	...
	echo T_("Video");                                                                 // Line 106
	echo T_("Sound");                                                                 // Line 84
	echo T_("APK");                                                                   // Line 91
	echo T_("ZIP");                                                                   // Line 97
	echo T_("Other");                                                                 // Line 55
	...
	echo T_("Group");                                                                 // Line 293
	echo T_("Select one group");                                                      // Line 130
	echo T_("Enable");                                                                // Line 89
	echo T_("Disable");                                                               // Line 94
	...
	echo T_("SMS Service number");                                                    // Line 125
	echo T_("sms of festival");                                                       // Line 127
	echo T_("Enter a valid sms");                                                     // Line 127
	echo T_("telegram");                                                              // Line 66
	echo T_("telegram of festival");                                                  // Line 136
	echo T_("Enter a valid telegram");                                                // Line 136
	echo T_("facebook");                                                              // Line 75
	echo T_("facebook of festival");                                                  // Line 145
	echo T_("Enter a valid facebook");                                                // Line 145
	echo T_("twitter");                                                               // Line 84
	echo T_("twitter of festival");                                                   // Line 154
	echo T_("Enter a valid twitter");                                                 // Line 154
	echo T_("instagram");                                                             // Line 93
	echo T_("instagram of festival");                                                 // Line 95
	echo T_("Enter a valid instagram");                                               // Line 163
	echo T_("linkedin");                                                              // Line 102
	echo T_("linkedin of festival");                                                  // Line 172
	echo T_("Enter a valid linkedin");                                                // Line 172
	echo T_("website");                                                               // Line 111
	echo T_("Festival website like http://example.com");                              // Line 208
	echo T_("Enter a valid website");                                                 // Line 208
	...
	echo T_("Click to download");                                                     // Line 101
	echo T_("MP3");                                                                   // Line 109
	echo T_("Without preview");                                                       // Line 113
	...
	//-------------------------------------content_m\festival\transaction\display.html
	echo T_("Today");                                                                 // Line 264
	echo T_("Course");                                                                // Line 56
	...
	echo T_("Date created");                                                          // Line 289
	echo T_("Files");                                                                 // Line 17
	echo T_("Checked");                                                               // Line 33
	echo T_("Win");                                                                   // Line 35

	//---------------------------------------------------content_m\hadith\display.html
	echo T_("Language");                                                              // Line 144
	echo T_("Hadith text");                                                           // Line 92
	echo T_("Active");                                                                // Line 315
	echo T_("Deactive");                                                              // Line 315
	...
	echo T_("Sms management");                                                        // Line 46
	echo T_("Signup karbala");                                                        // Line 56
	echo T_("Add trip");                                                              // Line 65
	echo T_("Tankyou message");                                                       // Line 84
	echo T_("Meeting");                                                               // Line 95
	echo T_("CMS");                                                                   // Line 23
	echo T_("Admin Contact");                                                         // Line 42
	echo T_("Report");                                                                // Line 19
	echo T_("Home page number");                                                      // Line 61
	echo T_("Send SMS");                                                              // Line 80
	echo T_("SMS Template");                                                          // Line 116
	echo T_("Donate product list");                                                   // Line 127
	echo T_("Donate list");                                                           // Line 13
	echo T_("Products");                                                              // Line 230
	echo T_("Doyon");                                                                 // Line 251
	echo T_("Group trip request");                                                    // Line 147
	echo T_("Family trip request");                                                   // Line 157
	echo T_("request service list");                                                  // Line 167
	...
	echo T_("Meeting title");                                                         // Line 69
	echo T_("Meeting Order");                                                         // Line 76
	echo T_("No member registered yet!");                                             // Line 87
	...
	echo T_("Without title");                                                         // Line 119
	...
	echo T_("Book transaction list");                                                 // Line 16
	...
	//------------------------------------------------content_m\report\travel\chart.js

	//--------------------------------------------content_m\report\travel\display.html

	//-----------------------------------------------content_m\report\travel\sankey.js
	...
	//---------------------------------------------content_m\trip\profile\display.html

	//---------------------------------------------content_m\trip\setting\display.html
	echo T_("Reset datecreate to");                                                   // Line 15
	echo T_("Save reserve date and description");                                     // Line 43

	//----------------------------------------------content_m\trip\status\display.html
	...
	echo T_("Sms text");                                                              // Line 113
	echo T_("Reseive status");                                                        // Line 88
	echo T_("Send status");                                                           // Line 94
	echo T_("Answer");                                                                // Line 91
	echo T_("Recommend");                                                             // Line 125
	echo T_("togateway");                                                             // Line 53
	...
	echo T_("Private");                                                               // Line 313
	echo T_("Reports");                                                               // Line 10
	...
	echo T_("Send by gateway");                                                       // Line 181
	echo T_("From the sender");                                                       // Line 184
	echo T_("From the sms panel");                                                    // Line 185
