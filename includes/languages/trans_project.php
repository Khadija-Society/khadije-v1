...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Enter a valid amount");                                                  // Line 166
	...
	echo T_("allowed extentions jpg, png (gif for bussiness plans). Max 500Kb");      // Line 81
	...
	echo T_("Title");                                                                 // Line 121
	echo T_("Title of festival course");                                              // Line 56
	echo T_("Enter a valid title");                                                   // Line 121
	...
	echo T_("Language");                                                              // Line 105
	echo T_("Hadith text");                                                           // Line 92
	echo T_("Active");                                                                // Line 152
	echo T_("Deactive");                                                              // Line 152
	...
	echo T_("Picture");                                                               // Line 40
	echo T_("Desctiption");                                                           // Line 41
	echo T_("Enter a valid count");                                                   // Line 144

	//---------------------------------------------------------content_cp\options.html
	echo T_("Sort");                                                                  // Line 175
	echo T_("Enter a valid sort");                                                    // Line 175
