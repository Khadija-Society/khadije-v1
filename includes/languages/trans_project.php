...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("No record exist!");                                                      // Line 116
	...
	echo T_("Click and go to khadije site");                                          // Line 103
	echo T_("Wrote your heart sounds");                                               // Line 114
	echo T_("optional");                                                              // Line 126
	echo T_("Not require");                                                           // Line 123
	echo T_("Mobile number is not showing on site and optional");                     // Line 126
	echo T_("Press here to send");                                                    // Line 130
