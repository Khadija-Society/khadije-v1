...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Male");                                                                  // Line 126
	echo T_("Female");                                                                // Line 131
	echo T_("Marital");                                                               // Line 424
	...
	echo T_("Start date");                                                            // Line 520
	echo T_("End date");                                                              // Line 529
	...
	echo T_("National card photo");                                                   // Line 84
	echo T_("Remove file");                                                           // Line 90
	echo T_("Iranian must fill");                                                     // Line 161
	echo T_("Foreigners must fill");                                                  // Line 98
	...
	//-----------------------------------------------content_cp\report\travel\chart.js

	//-------------------------------------------content_cp\report\travel\display.html

	//----------------------------------------------content_cp\report\travel\sankey.js
	...
	//--------------------------------------------content_cp\trip\profile\display.html
