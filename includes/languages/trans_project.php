...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Enter");                                                                 // Line 114
	echo T_("Signup");                                                                // Line 8
	echo T_("Misson & Target");                                                       // Line 22
	echo T_("Vision");                                                                // Line 136
	echo T_("Honors");                                                                // Line 137
	echo T_("FAQ");                                                                   // Line 25
	echo T_("Contact");                                                               // Line 26
	echo T_("Doners");                                                                // Line 180
	echo T_("Register for group trip");                                               // Line 42
	echo T_("Developed by Ermile");                                                   // Line 192
	...
	echo T_("Homepage");                                                              // Line 81
	echo T_("News");                                                                  // Line 35
	echo T_("Khadije Wiki");                                                          // Line 64
	echo T_("Services");                                                              // Line 169
	echo T_("Self expressions");                                                      // Line 85
	echo T_("Khadijah cultural and artistic charity was established in 2015 with the purpose of developing the Ahlul-Bayt <small>peace be upon them</small> pilgrimage culture and with two priorities of Ahlul-Bayt pilgrimage and the revival of forgotten traditions such as sacrifice, giving food on Ghadir day and ... has continued its activities.");// Line 106
	echo T_("User Panel");                                                            // Line 110
	echo T_("Signup in Khadije charity");                                             // Line 115
	echo T_("Enamad");                                                                // Line 123
	echo T_("Mission");                                                               // Line 135
	...
	echo T_("Deputy pilgrimage");                                                     // Line 63
	echo T_("Virtual pilgrimage");                                                    // Line 51
	echo T_("Requests");                                                              // Line 18
	echo T_("Individual registration");                                               // Line 162
	echo T_("Group registration");                                                    // Line 163
	echo T_("Servants registration");                                                 // Line 45
	echo T_("Consulting service");                                                    // Line 171
	echo T_("Health service");                                                        // Line 172
	echo T_("Help");                                                                  // Line 177
	echo T_("Other Languages");                                                       // Line 184
	echo T_("Software Solution Designer");                                            // Line 192
	echo T_("Aparat");                                                                // Line 221
	echo T_("Eitaa");                                                                 // Line 224
	echo T_("Soroush App");                                                           // Line 226

	//-----------------------------------------------------content/health/display.html

	//-------------------------------------------------------content/home/display.html
	echo T_("Read more");                                                             // Line 131
	echo T_("O Allah, let Your Peace come upon Muhammad and the family of Muhammad"); // Line 30
	echo T_("You also partake in salawat");                                           // Line 32
	echo T_("Say salawat and press here");                                            // Line 34
	echo T_("Collective or individual travel");                                       // Line 57
	echo T_("Balloting names");                                                       // Line 69
	echo T_("Tv show Sahargahan haram");                                              // Line 75
	echo T_("Join to the charity and participate in the pilgrimage reward");          // Line 82
	echo T_("The financial credibility of this project is provided by cash and non-cash donations from benefactors and lovers of Ahlul-Bayt.");// Line 83
	echo T_("Therefore, donors and people who are willing participate in the pilgrimage plans of the Ahlul-Bayt, can pay their cash through the following methods.");// Line 83
	echo T_("in Resalat bank of Iran");                                               // Line 86
	echo T_("Card number");                                                           // Line 90
	echo T_("Account number");                                                        // Line 93
	echo T_("Iranian bank Shaba number");                                             // Line 96
	echo T_("You can change amount of your donation");                                // Line 104
	echo T_("Donate as anonymous");                                                   // Line 107
	echo T_("Donate with register details");                                          // Line 112
	echo T_("Latest News");                                                           // Line 120
	echo T_("Mr.Farahzad's statement");                                               // Line 154
	echo T_("Contact with manager");                                                  // Line 165
	...
	echo T_("Clear filters");                                                         // Line 109
	echo T_("Result not found!");                                                     // Line 108
	echo T_("Search with new keywords.");                                             // Line 108
	echo T_("No record exist!");                                                      // Line 115
	echo T_("Total Request");                                                         // Line 122
	echo T_("Today");                                                                 // Line 131
	...
	echo T_("Donate list");                                                           // Line 129
	echo T_("Book transaction list");                                                 // Line 30
	echo T_("Report");                                                                // Line 44
	...
	echo T_("Pages");                                                                 // Line 38
	echo T_("Comments");                                                              // Line 39
	echo T_("Users");                                                                 // Line 46
	echo T_("Add new user");                                                          // Line 48
	echo T_("Permissions");                                                           // Line 49
	echo T_("SMS");                                                                   // Line 56
	echo T_("Quick send");                                                            // Line 58
	echo T_("Group send");                                                            // Line 59
	echo T_("Templates");                                                             // Line 60
