...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Servants registration");                                                 // Line 190
	echo T_("Deputy pilgrimage");                                                     // Line 205
	echo T_("Consulting");                                                            // Line 107
	echo T_("O Allah, let Your Peace come upon Muhammad and the family of Muhammad"); // Line 42
	echo T_("You also partake in salawat");                                           // Line 44
	echo T_("Allahouma sali ala mohamed wa ali muhammad");                            // Line 46
	echo T_("Say salawat");                                                           // Line 46
	echo T_("and press here");                                                        // Line 46
	...
	echo T_("Virtual pilgrimage");                                                    // Line 209
	echo T_("Travel request");                                                        // Line 94
	echo T_("Balloting names");                                                       // Line 207
	echo T_("My love story book");                                                    // Line 179
	echo T_("Join to the charity and participate in the pilgrimage reward");          // Line 132
	echo T_("Samte Khoda");                                                           // Line 134
	echo T_("The financial credibility of this project is provided by cash and non-cash donations from benefactors and lovers of Ahlul-Bayt.");// Line 142
	echo T_("Therefore, donors and people who are willing participate in the pilgrimage plans of the Ahlul-Bayt, can pay their cash through the following methods.");// Line 142
	echo T_("You can change amount of your donation");                                // Line 151
	echo T_("Donate as anonymous");                                                   // Line 154
	echo T_("Donate with register details");                                          // Line 159
	echo T_("Latest News");                                                           // Line 171
	echo T_("Archive");                                                               // Line 202
	echo T_("Mr.Farahzad's statement");                                               // Line 217
	echo T_("Shahid Mahdi Imani");                                                    // Line 110
	echo T_("Contact with manager");                                                  // Line 229
	echo T_("in Resalat bank of Iran");                                               // Line 238
	echo T_("Card number");                                                           // Line 276
	echo T_("Account number");                                                        // Line 279
	echo T_("Iranian bank Shaba number");                                             // Line 282
	echo T_("Tejarat bank");                                                          // Line 255
	echo T_("Bank Melli Iran");                                                       // Line 272

	//----------------------------------------------------content\karbala\display.html
	echo T_("Enter a valid name from 2 to 40 character");                             // Line 351
	echo T_("Last name");                                                             // Line 359
	echo T_("Enter a valid last name from 2 to 40 character");                        // Line 359
	echo T_("Father name");                                                           // Line 385
	echo T_("Like 09120123456");                                                      // Line 369
	echo T_("National code");                                                         // Line 375
	echo T_("Required");                                                              // Line 14
	echo T_("10 digit national code");                                                // Line 377
	echo T_("Birthday");                                                              // Line 67
	echo T_("Gender");                                                                // Line 65
	echo T_("Please select one itme");                                                // Line 30
	echo T_("Male");                                                                  // Line 110
	echo T_("Female");                                                                // Line 115
	echo T_("Marital");                                                               // Line 411
	echo T_("Single");                                                                // Line 410
	echo T_("Married");                                                               // Line 66
	echo T_("Yes");                                                                   // Line 419
	echo T_("No");                                                                    // Line 419
	echo T_("Arabic Language");                                                       // Line 420
	echo T_("Province");                                                              // Line 68
	echo T_("Select province");                                                       // Line 156
	echo T_("City");                                                                  // Line 69
	echo T_("Select city");                                                           // Line 167
	echo T_("Zip code");                                                              // Line 460
	echo T_("Passport id");                                                           // Line 470
	echo T_("Passport expire date");                                                  // Line 478
	echo T_("Address");                                                               // Line 70
	echo T_("Work Address");                                                          // Line 493
	echo T_("Description");                                                           // Line 500
	echo T_("Like");                                                                  // Line 536
	echo T_("Phone");                                                                 // Line 71
	echo T_("Education");                                                             // Line 575
	echo T_("Education course");                                                      // Line 584
	echo T_("Job");                                                                   // Line 593
	echo T_("Are you an univercity student?");                                        // Line 302
	echo T_("Add");                                                                   // Line 28
	echo T_("Signup");                                                                // Line 322
	echo T_("Country");                                                               // Line 436
	echo T_("Choose your country");                                                   // Line 327

	//--------------------------------------------------------content\main\layout.html
	echo T_("Website header");                                                        // Line 38
	echo T_("Homepage");                                                              // Line 293
	echo T_("About");                                                                 // Line 298
	echo T_("News");                                                                  // Line 75
	...
	echo T_("Direct download Khadije charity app");                                   // Line 110
	...
	echo T_("Mashhad");                                                               // Line 162
	echo T_("Karbala");                                                               // Line 153
	...
	echo T_("Enter a valid amount");                                                  // Line 213
	echo T_("Please select one item");                                                // Line 123
	...
	echo T_("Save");                                                                  // Line 45
	echo T_("Remove");                                                                // Line 617
	...
	echo T_("Terms and conditions");                                                  // Line 307
	echo T_("Accept");                                                                // Line 43
	echo T_("Reject");                                                                // Line 323
	...
	echo T_("Nesbat");                                                                // Line 428
	echo T_("Home Address");                                                          // Line 488
	echo T_("Add as new partner");                                                    // Line 600
	...
	echo T_("Without name");                                                          // Line 180
	echo T_("Visitor detail");                                                        // Line 99
	echo T_("Created on");                                                            // Line 113
	echo T_("Clear filters");                                                         // Line 144
	echo T_("Result not found!");                                                     // Line 143
	echo T_("Search with new keywords.");                                             // Line 143
	echo T_("No record exist!");                                                      // Line 113
	...
	echo T_("Action");                                                                // Line 126
	echo T_("View");                                                                  // Line 91

	//-----------------------------------------content_cp\consulting\view\display.html
	echo T_("Status of service");                                                     // Line 27
	echo T_("inapropirate request and spam detected");                                // Line 289
	echo T_("Draft");                                                                 // Line 313
	echo T_("try to fill request");                                                   // Line 313
	echo T_("cancel from user");                                                      // Line 318
	echo T_("Save changes");                                                          // Line 611
	...
	//----------------------------------------------content_cp\disalltrip\display.html
	...
	echo T_("Can trip user to qom");                                                  // Line 144
	echo T_("Maximum partner count for qom");                                         // Line 57
	echo T_("Can trip user to karbala");                                              // Line 153
	echo T_("Maximum partner count for karbala");                                     // Line 72
	echo T_("Can trip user to mashhad");                                              // Line 162
	echo T_("Maximum partner count for mashhad");                                     // Line 86
	echo T_("Group trip options");                                                    // Line 111
	echo T_("Enable Group Trip");                                                     // Line 135
	echo T_("Minimum group count");                                                   // Line 169
	echo T_("Minimum partner count");                                                 // Line 170
	echo T_("Maximum group count");                                                   // Line 177
	echo T_("Maximum partner count");                                                 // Line 178

	//----------------------------------------content_cp\festival\address\display.html
	...
	//---------------------------------------------content_cp\festival\course\add.html
	echo T_("Title");                                                                 // Line 137
	echo T_("Title of festival course");                                              // Line 56
	echo T_("Enter a valid title");                                                   // Line 137
	...
	echo T_("Enable");                                                                // Line 253
	echo T_("Disable");                                                               // Line 263
	...
	//--------------------------------------------content_cp\festival\course\list.html
	...
	//-----------------------------------------content_cp\festival\festivaldetail.html
	...
	echo T_("Count");                                                                 // Line 200
	echo T_("Price Variation");                                                       // Line 42

	//-----------------------------------------content_cp\festival\home\dashboard.html
	...
	//-------------------------------------------------content_cp\festival\layout.html
	echo T_("Slug");                                                                  // Line 144
	...
	//------------------------------------------------content_cp\festival\sidenav.html
	echo T_("Statistics");                                                            // Line 97
	echo T_("Hadith");                                                                // Line 100

	//-----------------------------------------content_cp\festival\status\display.html
	echo T_("Change festival status");                                                // Line 10

	//-----------------------------------------content_cp\festival\supporter\list.html
	echo T_("Add new supporter");                                                     // Line 13

	//------------------------------------content_cp\festival\transaction\display.html
	...
	echo T_("Language");                                                              // Line 121
	echo T_("Hadith text");                                                           // Line 92
	echo T_("Active");                                                                // Line 176
	echo T_("Deactive");                                                              // Line 176
	...
	//---------------------------------------------content_cp\meeting\add\display.html
	...
	//-------------------------------------------------content_cp\meeting\display.html
	...
	//----------------------------------------------content_cp\myhomepage\display.html

	//-----------------------------------------------content_cp\myrequest\display.html

	//-------------------------------------------content_cp\mytransaction\display.html
	...
	echo T_("Picture");                                                               // Line 47
	echo T_("Desctiption");                                                           // Line 41
	echo T_("Enter a valid count");                                                   // Line 168
	...
	//---------------------------------------content_cp\report\hazinekard\display.html

	//---------------------------------------------content_cp\report\home\display.html
	echo T_("Report Count transaction group by name");                                // Line 34
	echo T_("Report Count transaction group by payment and hazinekard");              // Line 44
	...
	echo T_("Categries");                                                             // Line 78
	echo T_("Tags");                                                                  // Line 81
	echo T_("Pages");                                                                 // Line 84

	//-----------------------------------------content_cp\thankyoumessage\display.html
	echo T_("Message text");                                                          // Line 25
	echo T_("Send sms?");                                                             // Line 40
	echo T_("Send thankyou message?");                                                // Line 51

	//------------------------------------------------content_cp\trip\add\display.html
