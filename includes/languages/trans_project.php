...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Karbala");                                                               // Line 226
	echo T_("Can trip user to karbala");                                              // Line 141
	echo T_("Mashhad");                                                               // Line 218
	...
	echo T_("Awaiting");                                                              // Line 47
	echo T_("send new complete request");                                             // Line 206
	echo T_("Spam");                                                                  // Line 105
	...
	echo T_("Representation");                                                        // Line 12
	echo T_("Health Service");                                                        // Line 11
	...
	echo T_("For share via social networks");                                         // Line 36
	echo T_("News Code");                                                             // Line 36
	...
	echo T_("Group registration");                                                    // Line 157
	echo T_("Individual registration");                                               // Line 156
	...
	echo T_("Vision");                                                                // Line 135
	echo T_("Honors");                                                                // Line 136
	echo T_("FAQ");                                                                   // Line 25
	echo T_("Doners");                                                                // Line 185
	echo T_("Register for group trip");                                               // Line 42
	echo T_("Developed by Ermile");                                                   // Line 197
	...
	echo T_("City Place");                                                            // Line 43
	echo T_("Please select one itmes");                                               // Line 45
