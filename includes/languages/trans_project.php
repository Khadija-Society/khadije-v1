...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Consulting service");                                                    // Line 170
	echo T_("Health service");                                                        // Line 171
	echo T_("Help");                                                                  // Line 175
	echo T_("Doners");                                                                // Line 34
	echo T_("Other Languages");                                                       // Line 182
	echo T_("Software Solution Designer");                                            // Line 190
	echo T_("Developed by Ermile");                                                   // Line 50
	echo T_("Aparat");                                                                // Line 219
	echo T_("Eitaa");                                                                 // Line 222
	echo T_("Soroush App");                                                           // Line 224
	...
	echo T_("Mashhad");                                                               // Line 164
	echo T_("Karbala");                                                               // Line 155
	...
	echo T_("Advice Service");                                                        // Line 10
	...
	echo T_("Clear filters");                                                         // Line 136
	echo T_("Result not found!");                                                     // Line 135
	echo T_("Search with new keywords.");                                             // Line 135
	echo T_("No record exist!");                                                      // Line 142
	...
	echo T_("Niyat");                                                                 // Line 98
	echo T_("Hazinekard");                                                            // Line 99

	//----------------------------------------------content_cp\familytrip\display.html
	echo T_("All trip");                                                              // Line 10
	echo T_("All");                                                                   // Line 13
	echo T_("Group trip");                                                            // Line 22
	echo T_("Family trip");                                                           // Line 28
	echo T_("Familty trip");                                                          // Line 31
	echo T_("Search in trips");                                                       // Line 79
	echo T_("ID");                                                                    // Line 92
	echo T_("Birthdate");                                                             // Line 95
	echo T_("Date created");                                                          // Line 38

	//--------------------------------------content_cp\familytrip\options\display.html
	echo T_("Family trip options");                                                   // Line 23
	echo T_("Enable Family Trip");                                                    // Line 52
	echo T_("Can trip user to qom");                                                  // Line 146
	echo T_("Maximum partner count for qom");                                         // Line 57
	echo T_("Can trip user to karbala");                                              // Line 155
	echo T_("Maximum partner count for karbala");                                     // Line 72
	echo T_("Can trip user to mashhad");                                              // Line 164
	echo T_("Maximum partner count for mashhad");                                     // Line 86
	echo T_("Group trip options");                                                    // Line 112
	echo T_("Enable Group Trip");                                                     // Line 137
	echo T_("Minimum group count");                                                   // Line 171
	echo T_("Minimum partner count");                                                 // Line 172
	echo T_("Maximum group count");                                                   // Line 179
	echo T_("Maximum partner count");                                                 // Line 180

	//-----------------------------------------content_cp\familytrip\view\display.html
	...
	echo T_("Report Count transaction group by payment and hazinekard");              // Line 18
	echo T_("Report sum transaction group by hazinekard");                            // Line 27
	echo T_("Report daily");                                                          // Line 36
	echo T_("Report Month");                                                          // Line 47
	...
	echo T_("Request family trip list");                                              // Line 22
	...
	echo T_("Maximum people can signup as awaiting");                                 // Line 68
	echo T_("User can set date of trip");                                             // Line 76
