...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Cancel");                                                                // Line 57
	echo T_("Edit");                                                                  // Line 113
	echo T_("register for new group request");                                        // Line 49
	echo T_("Start Date");                                                            // Line 70
	echo T_("End Date");                                                              // Line 79
	echo T_("Add");                                                                   // Line 364
	echo T_("Save");                                                                  // Line 52
	echo T_("Remove");                                                                // Line 210
	...
	echo T_("OK");                                                                    // Line 14
	echo T_("Description");                                                           // Line 266
	echo T_("Job");                                                                   // Line 347
	echo T_("Save all");                                                              // Line 78
	echo T_("Start date");                                                            // Line 92
	echo T_("End date");                                                              // Line 99
	echo T_("Expert title");                                                          // Line 102
	echo T_("Expert value");                                                          // Line 111
	echo T_("Expert year");                                                           // Line 119
	echo T_("Your car name");                                                         // Line 127
	echo T_("Yes");                                                                   // Line 355
	echo T_("No");                                                                    // Line 355
	echo T_("Arabic Language");                                                       // Line 192
	...
	echo T_("Nationalcode thumb");                                                    // Line 162
	...
	echo T_("Passport id");                                                           // Line 236
	echo T_("Foreigners must fill");                                                  // Line 202
	echo T_("Name");                                                                  // Line 112
	echo T_("Require");                                                               // Line 222
	echo T_("Enter a valid name from 2 to 40 character");                             // Line 112
	echo T_("Last name");                                                             // Line 120
	echo T_("Enter a valid last name from 2 to 40 character");                        // Line 120
	echo T_("Gender");                                                                // Line 163
	echo T_("Male");                                                                  // Line 166
	echo T_("Female");                                                                // Line 167
	echo T_("Marital");                                                               // Line 175
	echo T_("Single");                                                                // Line 178
	echo T_("Married");                                                               // Line 179
	echo T_("Mobile");                                                                // Line 179
	echo T_("Like 09120123456");                                                      // Line 136
	echo T_("National code");                                                         // Line 142
	echo T_("Iranian must fill");                                                     // Line 108
	echo T_("10 digit national code");                                                // Line 144
	echo T_("Father name");                                                           // Line 128
	echo T_("Birthday");                                                              // Line 150
	echo T_("Nesbat");                                                                // Line 441
	echo T_("Country");                                                               // Line 377
	echo T_("Province");                                                              // Line 202
	echo T_("City");                                                                  // Line 213
	echo T_("Zip code");                                                              // Line 226
	echo T_("Passport expire date");                                                  // Line 244
	echo T_("Home Address");                                                          // Line 501
	echo T_("Work Address");                                                          // Line 259
	echo T_("Phone");                                                                 // Line 279
	echo T_("Like");                                                                  // Line 290
	echo T_("Email");                                                                 // Line 190
	echo T_("Education");                                                             // Line 329
	echo T_("Education course");                                                      // Line 338
	...
	echo T_("Representation");                                                        // Line 160
	echo T_("Delneveshte");                                                           // Line 142
	echo T_("Donate");                                                                // Line 216
	...
	echo T_("Please select one itme");                                                // Line 177
	echo T_("Select province");                                                       // Line 204
	echo T_("Select city");                                                           // Line 215
	echo T_("Address");                                                               // Line 254
	echo T_("Are you an univercity student?");                                        // Line 356
	echo T_("Choose your country");                                                   // Line 381
	...
	echo T_("Clear filters");                                                         // Line 132
	echo T_("Result not found!");                                                     // Line 131
	echo T_("Search with new keywords.");                                             // Line 131
	echo T_("No record exist!");                                                      // Line 138
	...
	echo T_("Expert");                                                                // Line 61
	echo T_("Action");                                                                // Line 63
	echo T_("View");                                                                  // Line 81
	...
	echo T_("Enter");                                                                 // Line 145
	echo T_("Misson & Target");                                                       // Line 22
	echo T_("Honors");                                                                // Line 168
	echo T_("FAQ");                                                                   // Line 25
	echo T_("Doners");                                                                // Line 217
	echo T_("Register for group trip");                                               // Line 42
	echo T_("Developed by Ermile");                                                   // Line 229

	//--------------------------------------------------content/old/v2/donateForm.html
	echo T_("List of last success donations");                                        // Line 90
	echo T_("Requested");                                                             // Line 129
	echo T_("Your help");                                                             // Line 135
	echo T_("Enter a valid number");                                                  // Line 135
	echo T_("Pay");                                                                   // Line 154
	echo T_("Your name");                                                             // Line 162
	echo T_("Enter a valid name");                                                    // Line 162
	echo T_("Full name");                                                             // Line 168
	echo T_("Enter a valid last name");                                               // Line 159
	echo T_("Enter a valid mobile");                                                  // Line 170
	echo T_("Intent");                                                                // Line 199
	echo T_("Intention to donate this fee");                                          // Line 201
	echo T_("Enter a valid niyat");                                                   // Line 190
	echo T_("Pay Amount");                                                            // Line 149
	echo T_("Total Pay Amount");                                                      // Line 222
	echo T_("Show in public doners list?");                                           // Line 230
	echo T_("Check doners list");                                                     // Line 230
	echo T_("Yes, show my name and price");                                           // Line 233
	echo T_("No, Show as anonymous");                                                 // Line 238
	echo T_("Manual");                                                                // Line 247
	echo T_("Normal");                                                                // Line 247
	echo T_("Admin direct pay");                                                      // Line 248
	echo T_("Spending method");                                                       // Line 268
	...
	echo T_("Group registration");                                                    // Line 189
	echo T_("Individual registration");                                               // Line 188
