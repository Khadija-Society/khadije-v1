...
class twigTransTerms
{
 private function transtext()
 {
	...
	echo T_("Try to start with add new product!");                                    // Line 153
