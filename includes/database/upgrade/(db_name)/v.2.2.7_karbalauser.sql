...
--
-- Indexes for table `karbalausers`
--
ALTER TABLE `karbalausers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `index_search_karbala_mobile` (`mobile`),
  ADD KEY `index_search_karbala_nationalcode` (`nationalcode`),
  ADD KEY `index_search_karbala_pasportcode` (`pasportcode`),
  ADD KEY `index_search_karbala_android_uniquecode` (`android_uniquecode`),
  ADD KEY `index_search_karbala_email` (`email`),
  ADD KEY `index_search_karbala_username` (`username`);
...
--
-- AUTO_INCREMENT for table `karbalausers`
--
ALTER TABLE `karbalausers`
