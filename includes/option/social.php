...
self::$social['list']['facebook']                      = 'mhkhadije';
self::$social['list']['twitter']                       = 'mhkhadije';
...
* FACEBOOK
*/
self::$social['facebook']['status']                    = null;
...
self::$social['facebook']['api_version']               = null;
...
* GOOGLE
*/
self::$social['google']['status']                      = null;
self::$social['google']['client_id']                   = null;
self::$social['google']['project_id']                  = null;
self::$social['google']['auth_uri']                    = null;
self::$social['google']['token_uri']                   = null;
self::$social['google']['auth_provider_x509_cert_url'] = null;
self::$social['google']['client_secret']               = null;

/**
* TWITTER
*/
self::$social['twitter']['status']                     = null;
...
* GOOGLE PLUS
*/
self::$social['googleplus']['status']                  = null;
...
* GITHUB
*/
self::$social['github']['status']                      = null;
...
* LINKDIN
*/
self::$social['linkedin']['status']                    = null;
...
* APARAT
*/
self::$social['aparat']['status']                      = null;
