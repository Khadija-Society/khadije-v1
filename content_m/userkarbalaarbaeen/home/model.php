...
class model
{
	...
	public static function export_list()
	{
		...
		$link                = null;
		$result              = \lib\db\karbalaarbaeenusers::search(null, $_args);

		while ($result)
		{
			$result = array_map(["\\lib\\app\\karbalaarbaeenuser", "ready"], $result);
	...
	{
		$handle   = curl_init();
		curl_setopt($handle, CURLOPT_URL, \dash\url::kingdom().'/a/exportcurlkarbalaarbaeenusers');
