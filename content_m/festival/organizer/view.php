<?php
namespace content_m\festival\organizer;
...
class view
{
	...
	{
		\dash\data::display_festivalOrganizerDisplay('content_m/festival/organizer/list.html');
		...
		if(\dash\request::get('type') === 'add')
		{
			...
			\dash\data::display_festivalOrganizerDisplay('content_m/festival/organizer/add.html');
