<?php
namespace content_m\festival\supporter;
...
class view
{
	...
	{
		\dash\data::display_festivalSupporterDisplay('content_m/festival/supporter/list.html');
		...
		if(\dash\request::get('type') === 'add')
		{
			...
			\dash\data::display_festivalSupporterDisplay('content_m/festival/supporter/add.html');
