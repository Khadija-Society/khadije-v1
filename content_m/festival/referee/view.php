<?php
namespace content_m\festival\referee;
...
class view
{
	...
	{
		\dash\data::display_festivalRefereeDisplay('content_m/festival/referee/list.html');
		...
		if(\dash\request::get('type') === 'add')
		{
			...
			\dash\data::display_festivalRefereeDisplay('content_m/festival/referee/add.html');
