...
class view
{
	public static function config()
	{
		...
		\dash\data::page_title(\dash\data::dataRow_title(). ' | '. T_("Edit festival schedule detail"));
		\dash\data::page_desc(T_("Edit festival schedule detail to show in time line"));
