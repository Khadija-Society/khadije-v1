		...
		[
			...
			[
				...
				[
					...
					'adminoffice_rabet'     => ['ejob' => 'adminoffice', 'ejob_for' => 'rabet', "job" => "مسئول زائرسرا", 'job_for' => 'رابط', 'data' => []],
			...
			[
				...
				[
					...
					'admin_rabet'      => ['ejob' => 'admin', 'ejob_for' => 'rabet', "job" => "مدیر کاروان", 'job_for' => 'رابط', 'مداح', 'data' => []],
			...
			[
				...
				[
					...
					'missionary_rabet'      => ['ejob' => 'missionary', 'ejob_for' => 'rabet', "job" => "مبلغ", 'job_for' => 'رابط', 'data' => []],
			...
			[
				...
				[
					...
					'clergy_rabet'      => ['ejob' => 'clergy', 'ejob_for' => 'rabet', "job" => "روحانی", 'job_for' => 'رابط', 'data' => []],
			...
			[
				...
				[
					...
					'nazer_rabet'      => ['ejob' => 'nazer', 'ejob_for' => 'rabet', "job" => "ناظر", 'job_for' => 'رابط', 'data' => []],
			...
			[
				...
				[
					...
					'maddah_rabet'       => ['ejob' => 'maddah', 'ejob_for' => 'rabet', "job" => "مداح", 'job_for' => 'رابط', 'data' => []],
			...
			[
				...
				'list' =>
				[
					'rabet_admin'       => ['ejob' => 'rabet', 'ejob_for' => 'admin', "job" => "مداح", 'job_for' => 'مدیر کاروان', 'data' => []],
					'rabet_missionary'  => ['ejob' => 'rabet', 'ejob_for' => 'missionary', "job" => "مداح", 'job_for' => 'مبلغ', 'data' => []],
					'rabet_servant'     => ['ejob' => 'rabet', 'ejob_for' => 'servant', "job" => "مداح", 'job_for' => 'نگهبان', 'data' => []],
					'rabet_adminoffice' => ['ejob' => 'rabet', 'ejob_for' => 'adminoffice', "job" => "مداح", 'job_for' => 'روحانی کاروان', 'data' => []],
					'rabet_nazer'       => ['ejob' => 'rabet', 'ejob_for' => 'nazer', "job" => "مداح", 'job_for' => 'ناظر', 'data' => []],
					'rabet_maddah'       => ['ejob' => 'rabet', 'ejob_for' => 'maddah', "job" => "مداح", 'job_for' => 'مداح', 'data' => []],
					'rabet_clergy'      => ['ejob' => 'rabet', 'ejob_for' => 'clergy', "job" => "مداح", 'job_for' => 'مسئول زائرسرا', 'data' => []],
					'rabet_khadem'      => ['ejob' => 'rabet', 'ejob_for' => 'khadem', "job" => "مداح", 'job_for' => 'خادم', 'data' => []],
					'rabet_khadem2'     => ['ejob' => 'rabet', 'ejob_for' => 'khadem2', "job" => "مداح", 'job_for' => 'خادم ۲', 'data' => []],
				],
			],
			...
			[
				...
				[
					...
					'khadem_rabet'      => ['ejob' => 'khadem', 'ejob_for' => 'rabet', "job" => "خادم", 'job_for' => 'رابط', 'data' => []],
			...
			[
				...
				[
					...
					'khadem2_rabet'      => ['ejob' => 'khadem2', 'ejob_for' => 'rabet', "job" => "خادم ۲", 'job_for' => 'رابط', 'data' => []],
