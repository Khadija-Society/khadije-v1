<?php
namespace content_fp\mediasupporter\add;
...
class view
{
	public static function config()
	{
		...
		\content_fp\mediasupporter\load::festival();
		...
		\dash\data::display_mediasupporterAdd('content_fp/mediasupporter/layout.html');
