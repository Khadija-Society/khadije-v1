...
class view
{
	public static function config()
	{
		...
		if(isset($_SESSION['LOTTERY_NEW_SIGNUP']))
		{
			$_SESSION['LOTTERY_NEW_SIGNUP'] = null;
	...
	private static function check_nationalcode()
	{
		...
		$check = \lib\db\lottery_user::get(['nationalcode' => $nationalcode, 'lottery_id' => \dash\coding::decode(\dash\data::lotteryId()), 'limit' => 1]);
		if(isset($check['id']))
		{
			$status = 'signuped';
		}
