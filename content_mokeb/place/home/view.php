...
class view
{
	...
	{
		\dash\permission::access('mPlaceView');
		...
		$sortLink  = \dash\app\sort::make_sortLink(\lib\app\place::$sort_field, \dash\url::this());
		$dataTable = \lib\app\place::list(\dash\request::get('q'), $args);
